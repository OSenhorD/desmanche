...
<body class="min-h-screen bg-[#0b0e14] p-8 text-gray-300 font-sans antialiased">
    <div class="max-w-xl mx-auto mt-12">
        ...
        <div class="bg-[#161a21] rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-gray-800/50 p-10 relative overflow-hidden">
            ...
            <div class="mb-10">
                <h1 class="text-3xl font-extrabold text-white tracking-tight">Nova Categoria</h1>
                <p class="text-gray-500 text-sm mt-2">Preencha o nome para organizar seus produtos.</p>
            </div>
            ...
            @if ($errors->any())
                <div class="mb-8 p-4 bg-red-500/10 border-l-4 border-red-500 rounded-r-lg">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <span class="text-red-500 font-bold text-sm">Atenção:</span>
                    </div>
            ...
            <form method="POST" action="{{ route('api.admin.categories.store') }}" class="space-y-8">
                @csrf
                ...
                <div class="space-y-3">
                    ...
                    <div class="group relative">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" required
                            ...
                            class="w-full bg-[#0b0e14]/50 border border-gray-800 group-focus-within:border-[#1bc4a8] group-focus-within:ring-1 group-focus-within:ring-[#1bc4a8] text-gray-100 rounded-xl py-4 pl-11 pr-4 outline-none transition-all placeholder-gray-700 shadow-inner">
                    </div>
                </div>
